...
const BasicPayment = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate payment processing with a realistic gateway interaction
    setTimeout(() => {
      ...
      if (isSuccess) {
        ...
        setIsProcessing(false);
        setError('Transaction declined. Please try a different payment method or contact your bank.');
      }
    }, 2500);
  };
